...
import { AuthContext } from '../context/AuthContext';
 ...
 const Navbar = () => {
    ...
    const {isAuth,toggleAuth,flag} = React.useContext(AuthContext)
  ...
  return (
    <nav style={{backgroundColor:'cyan', height:"60px",display:'flex',gap:'30px',padding:'10px 30px',justifyContent:'right'}}>
        {flag ? <Button colorScheme='Red' onClick={handelClick}>Log Out</Button> : 
                    <>
